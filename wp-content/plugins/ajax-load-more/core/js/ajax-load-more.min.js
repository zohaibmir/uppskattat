...
alm.post_type=alm.content.attr('data-post-type');alm.post_type=alm.post_type.split(",");alm.container.append('<div class="'+alm.prefix+'btn-wrap"/>');alm.btnWrap=$('.'+alm.prefix+'btn-wrap',alm.container);if(alm.paging){alm.content.parent().addClass('loading');}else{$('.'+alm.prefix+'btn-wrap',alm.container).append('<div id="load-more" class="'+alm.prefix+'load-more-btn more'+alm.button_class+' loading">&nbsp;</div>');alm.button=$('.alm-load-more-btn',alm.container);}
