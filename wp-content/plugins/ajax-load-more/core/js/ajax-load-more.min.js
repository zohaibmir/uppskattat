...
alm.post_type=alm.content.attr('data-post-type');alm.post_type=alm.post_type.split(",");alm.container.append('<div class="'+alm.prefix+'btn-wrap"/>');alm.btnWrap=$('.'+alm.prefix+'btn-wrap',alm.container);if(alm.paging){alm.content.parent().addClass('loading');}else{$('.'+alm.prefix+'btn-wrap',alm.container).append('<div id="infscr-loading" style="display: none;"><img id="load-more" alt="Loading..." src="../../core/img/ajax-loader.gif"><div>');alm.button=$('.alm-load-more-btn',alm.container);}
